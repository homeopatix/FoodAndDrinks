...
------------------------------------------------------------------------------------------
	if( not settings.isOptionsWindowVisible or 
    not settings.borderShow or
    not settings["shortcuts"]["Type1"] or
...
function SaveSettings()
	settings["windowPosition"]["xPos"] = tostring(FoodAndDrinks:GetLeft());
    settings["windowPosition"]["yPos"] = tostring(FoodAndDrinks:GetTop());
